        ...
        <form action="{{route('permissions.store')}}" method="POST">
          ...
          <div class="block">
            <b-radio-group v-model="permissionType">
                <input type="radio" name="permission_type" value="basic">Basic Permission
                <input type="radio" name="permission_type" value="crud">CRUD Permission
            </b-radio-group>
          </div>
          ...
          <div class="columns" v-if="permissionType == 'crud'">
            <div class="column is-one-quarter">
              <b-checkbox-group v-model="crudSelected">
                <div class="field">
                  <input type="checkbox" custom-value="create">Create
                </div>
                <div class="field">
                  <input type="checkbox" custom-value="read">Read
                </div>
                <div class="field">
                  <input type="checkbox" custom-value="update">Update
                </div>
                <div class="field">
                  <input type="checkbox" custom-value="delete">Delete
                </div>
              </b-checkbox-group>
            </div> <!-- end of .column -->
