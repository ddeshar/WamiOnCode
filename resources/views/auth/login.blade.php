            ...
            <div class="card-content">
                ...
                <form role="form" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="field">
                        ...
                        <p class="control">
                            <input class="input {{$errors->has('email') ? 'is-danger' : ''}}" type="text" name="email" placeholder="name@example.com" value="{{old('email')}}">
                        </p>
                        @if($errors->has('email'))
                    ...
                    <label class="checkbox">
                        <input name="remember" class="m-t-20" type="checkbox"> Remember Me
                    </label>
